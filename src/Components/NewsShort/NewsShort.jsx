...
export default function NewsShort() {
    ...
    return (
        <section className={s.short_news}>
            ...
            <div className={s.news_list + ' ' + s.desktop}>
                {
                    news.map((item) => {
                        return (
                            <div className={s.item} key={item.key}>
                                ...
                                <div className={s.description}>
                                    <div className={s.content_text}>
                                        {item.text && item.text[0] && item.text[0].value.slice(0, 194) + "..."}
                                    </div>
            ...
            <div className={s.news_list + ' ' + s.mobile}>
                {
                    news.length > 0 && (
                        <div className={s.item} key={news[0].key}>
                            <div className={s.name}>
                                {news[0].title}
                            </div>
            ...
            <div className={s.all}>
                <Link to="/news" className={s.link + ' ' + s.desktop}>
                    <CustomButton text="Читати Всі Новини" />
                </Link>
                <Link to="/news" className={s.link + ' ' + s.mobile}>
                    <CustomButton text="Всі Новини" />
                </Link>
            </div>
        </section>
    )
